...
public class Bip32Cache {
    ...
    private static final byte INDEX_NOT_AVAILABLE = (byte) 0xff; // -1

    public Bip32Cache() {
        privateComponent = new byte[64]; // privKey + chaincode
        publicComponent = new byte[65]; // compressPubKey + chaincode
        path = new byte[40];
